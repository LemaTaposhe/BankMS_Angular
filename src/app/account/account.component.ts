...
//  ngOnInit(): void {
//    this.getAllAccounts();
//    this.loadCurrentUser(); // Load current user on init
...
//    if (this.currentUser) {
//      this.accountForm.userId = this.accountForm.userId || this.currentUser.userId; // Set userId from selected or current user
