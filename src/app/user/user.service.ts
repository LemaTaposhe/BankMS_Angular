...
////    return this.httpClient.get<User>(`${this.url}/GetUser/${id}`);
////  }

////  createUser(user: User): Observable<User> {
////    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) };
////    return this.httpClient.post<User>(`${this.url}/InsertUser`, user, httpOptions);
////  }

////  updateUser(id: number, user: User): Observable<User> {
////    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) };
////    return this.httpClient.put<User>(`${this.url}/UpdateUser/${id}`, user, httpOptions);
////  }

////  deleteUserById(id: number): Observable<number> {
////    const httpOptions = { headers: new HttpHeaders({ 'Content-Type': 'application/json' }) };
////    return this.httpClient.delete<number>(`${this.url}/DeleteUser/${id}`, httpOptions);
////  }
////}
import { Injectable } from '@angular/core';
...
export class UserService {
  ...
  //getAllUsers(): Observable<User[]> {
  //  return this.httpClient.get<User[]>(`${this.url}/GetUsers`, this.getHttpOptions())
  //    .pipe(
